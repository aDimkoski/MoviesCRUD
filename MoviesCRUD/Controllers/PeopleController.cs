...
namespace MoviesCRUD.Controllers
{
    public class PeopleController : Controller
    {
        ...
        {
            List<Role> rolesFromDb = _context.Role.ToList();
        ...
        public IActionResult Create(List<int> roles, Person person)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Role role1 = new Role();
                    if ((role1 = _context.Role.Find(role)) != null)
                    {
                        rolesList.Add(role1);
                    }
                }
                person.Roles = rolesList;
